<div class="p-10 lg:p-8 bg-white border-b border-gray-200">
    
    <div class="mx-auto mt-50 w-1/2 rounded-md border-2 space-y-4 border-blue-300 flex flex-col pb-3 pt-3">
        <input disabled id='inputCustomerId' class="p-0 mx-auto border-yellow-400 focus:ring-yellow-400 border-2 focus:border-yellow-400 rounded-lg" />
        <button class="bg-blue-500 hover:bg-blue-700 text-white rounded mx-auto pl-2 pr-2"
                wire:click="">get UserId</button>
